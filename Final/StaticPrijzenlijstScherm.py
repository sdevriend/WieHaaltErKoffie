...
class StaticPrijzenlijstscherm(wx.Panel):
    def __init__(self, parent, prijzen, tijd):
        """ 
        """
        self.tijd = tijd
    ...
    def scroll(self, paneel):
        ...
        self.stTxtFris = wx.StaticText (self.sw, -1, self.txtFris, pos = (15, 125))
        self.stTxtFris.SetForegroundColour((255,255,255))
        self.txtCtrlFris = wx.TextCtrl(self.sw, -1, value=(str(self.prijzen[3][2])),pos=(150, 120))
        self.txtCtrlFris.SetEditable(False)

        if self.tijd == "bier":
            txtBierTijd = "Lijst met extra dranken na koffietijd:"
            self.stTxtBierTijd = wx.StaticText (self.sw, -1, txtBierTijd, pos = (15, 155))
